<template>
  <div class="google-map-container">
    ...
    <div class="map-container">
      <img v-if="$router.currentRoute.name != 'profile'" @click="geolocate()" src="@/assets/icons/curr-location.png" alt="" />
      <gmap-map
        :center="center"
        :zoom="12"
        map-type-id="terrain"
...
//AIzaSyBWy4P1ESdTxeJAj3vKrgGzfMenC9LnKuM
export default {
  name: "GoogleMap",
  data() {
    return {
    ...
    getAddress(lating) {
        ...
        geocoder.geocode({ location: lating }, function (results, status) {
            ...
            if (results[1]) {
                ...
                This.complete_address = results[1];
            } else {
                return false;
            }
            }
