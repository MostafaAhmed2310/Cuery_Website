    ...
    <div class="messages-container">
        ...
        <div class="sections-body">
            ...
            <div class="sections-inputs-body">
                ...
                <div class="left-side">
                    <multiselect v-if="$t('nav.home') === 'Home'" v-model="selectedSection" :options="sections" label="service_title" :close-on-select="true" track-by="service_title" :searchable="true"  :show-labels="false" :placeholder='$t("sections.select_section")'></multiselect>
                    <multiselect v-if="$t('nav.home') === 'الرئيسية'" v-model="selectedSection" :options="sections" label="service_title_ar" :close-on-select="true" track-by="service_title_ar" :searchable="true"  :show-labels="false" :placeholder='$t("sections.select_section")'></multiselect>
